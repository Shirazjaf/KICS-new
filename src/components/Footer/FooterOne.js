            ...
            <div className="xl:w-1/4 md:w-1/2">
              <div className="footer-company-infor flex flex-col gap-5">
                <Link href="/" className="logo">
                  {classname ? (
                    <Image src={'/images/logo-kics.png'} width={5000} height={5000} alt="logo" className="w-[148px]" />
                  ) : (
                    <Image src={'/images/logo-original.png'} width={5000} height={5000} alt="logo" className="w-[248px]" />
                  )}
                </Link>
                <div className="caption1">We are pioneers in industrial and community development, offering innovative solutions across diverse sectors. From infrastructure development to skill training, we empower industries and communities to grow sustainably. </div>
              ...
              <div className="footer-navigate flex md:justify-evenly max-md:gap-20 max-sm:gap-y-6 max-sm:flex-wrap">
                <div className="footer-nav-item">
                  ...
                  <ul className="list-nav mt-3">
                    <li className="mt-2">
                      <Link className={`caption1 hover-underline ${classname && 'underline-white'}`} href="#">About us</Link>
                    </li>
                    <li className="mt-2">
          ...
          <div className="container">
            <div className="flex items-center sm:justify-between max-sm:flex-col gap-y-2 justify-center py-2 border-t border-outline">
              <div className="left-block flex items-center">
                <div className="copy-right text-surface1 caption1">©2024 KICS. All Rights Reserved.</div>
              </div>
